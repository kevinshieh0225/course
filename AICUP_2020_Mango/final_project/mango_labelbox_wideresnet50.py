...
if __name__ == '__main__':
    ...
    for class_index in range(5):
        ##############################################自己取名########################################################
        name = f'wideresnet50_ft_diseasepart_{class_index}'
        ##############################################自己取名########################################################
        batchsize = 32
    ...
    for class_index in range(5):
        ...
        p,r,f1 = predict_real_f1(model_ft , class_index, path_dev, label_dev, box_path_dev)
        f1_history[f'class_{class_index}'] = {'precision':p , 'recall':r , 'F1':f1}
    with open(f'./result_disease/result_wideresnet50_opt_all.json', 'w') as json_file:
